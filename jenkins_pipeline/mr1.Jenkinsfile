...
pipeline {
    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf mr1'
                sh 'git clone --recursive --depth=1 https://github.com/tomverbeure/mr1 mr1'
            }
        }
                    ...
                    stages {
                        ...
                        stage('Flash digilent_arty_a7_100t') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p mr1 -b digilent_arty_a7_100t -l'
                                }
                            }
                        }
