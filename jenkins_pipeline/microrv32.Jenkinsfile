    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf *.xml'
                sh 'rm -rf microrv32'
                sh 'git clone --recursive --depth=1 https://github.com/agra-uni-bremen/microrv32 microrv32'
            }
        }
                    ...
                    stages {
                        stage('Synthesis and PnR') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p microrv32 -b digilent_arty_a7_100t'
                                }
                            }
                        }
                        stage('Flash digilent_arty_a7_100t') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p microrv32 -b digilent_arty_a7_100t -l'
                                }
                            }
                        }
