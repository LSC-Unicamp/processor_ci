...
pipeline {
    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf rsd'
                sh 'git clone --recursive --depth=1 https://github.com/rsd-devel/rsd rsd'
            }
        }
                    ...
                    stages {
                        ...
                        stage('Flash digilent_arty_a7_100t') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config.json \
                                            -p rsd -b digilent_arty_a7_100t -l'
                                }
                            }
                        }
