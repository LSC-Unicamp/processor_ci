...
pipeline {
    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf I2SRV64-SS-v1'
                sh 'git clone --recursive --depth=1 https://github.com/RClabiisc/I2SRV64-SS-v1 I2SRV64-SS-v1'
            }
        }
                    ...
                    stages {
                        stage('Synthesis and PnR') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config.json \
                                            -p I2SRV64-SS-v1 -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config.json \
                                            -p I2SRV64-SS-v1 -b colorlight_i9 -l'
                                }
                            }
                        }
                    ...
                    stages {
                        stage('Synthesis and PnR') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config.json \
                                            -p I2SRV64-SS-v1 -b digilent_arty_a7_100t'
                                }
                            }
                        }
                        stage('Flash digilent_arty_a7_100t') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config.json \
                                            -p I2SRV64-SS-v1 -b digilent_arty_a7_100t -l'
                                }
                            }
                        }
