    ...
    stages {
        stage('Git Clone') {
            steps {
                ...
                sh 'git clone --recursive --depth=1 https://github.com/chipsalliance/Cores-VeeR-EH1 Cores-VeeR-EH1'
            }
        }
                    ...
                    stages {
                        stage('Synthesis and PnR') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p Cores-VeeR-EH1 -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p Cores-VeeR-EH1 -b colorlight_i9 -l'
                                }
                            }
                        }
                    ...
                    stages {
                        stage('Synthesis and PnR') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p Cores-VeeR-EH1 -b digilent_arty_a7_100t'
                                }
                            }
                        }
                        stage('Flash digilent_arty_a7_100t') {
                            steps {
                                ...
                                sh 'python3 /eda/processor_ci/main.py -c /eda/processor_ci/config \
                                            -p Cores-VeeR-EH1 -b digilent_arty_a7_100t -l'
                                }
                            }
                        }
